...
import { Dokumen } from '@/types/dokumen.d';
...
const TabelDokumen = ({ data, loading, onDownload, onDelete }: Props) => {
    return (
            ...
            <Column
                ...
                body={(row: Dokumen) => (
                    <div className="flex gap-2">
                        <Button icon="pi pi-download" size="small" severity="info" onClick={() => onDownload(row)} />
