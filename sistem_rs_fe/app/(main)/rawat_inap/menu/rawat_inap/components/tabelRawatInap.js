...
const TabelRawatInap = ({ data, loading, onEdit, onDelete, setFormRawatInapMode, onCheckout, onCancelCheckout }) => {
  ...
  return (
    <DataTable value={data} paginator rows={10} rowsPerPageOptions={[10, 25, 50, 75, 100, 250, 500, 1000]} loading={loading} size="small" scrollable sortField="TANGGALMASUK" sortOrder={-1}>
      <Column
        field="NAMALENGKAP"
        header="Pasien"
      />
