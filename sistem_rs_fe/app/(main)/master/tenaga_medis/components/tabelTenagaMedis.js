...
const TabelTenagaMedis = ({ data, loading, onEdit, onDelete }) => {
  ...
  const listItem = (row, index) => {
    return (
      <div className="col-12" key={row.IDTENAGAMEDIS}>
              ...
              <div className="flex flex-column align-items-center sm:align-items-start gap-3">
                ...
                {row.SPESIALISASI && (
                  <div className="flex align-items-center gap-2 text-600">
                    ...
                    <span className="text-sm font-medium">{row.SPESIALISASI}</span>
                  </div>
                )}
              </div>
          ...
          <div className="flex flex-column h-full">
            ...
            >
              ...
              {row.SPESIALISASI && (
                <div className="flex align-items-center gap-2 text-600">
                  <i className="pi pi-star text-sm"></i>
                  <span className="text-sm text-center font-medium">{row.SPESIALISASI}</span>
                </div>
              )}
            </div>
        ...
        <div className="col-12">
          <Card>
            <div className="text-center p-5">
              <i className="pi pi-user-md text-6xl text-400 mb-3"></i>
              <h3 className="text-xl text-600">Tidak ada data</h3>
              <p className="text-500">Belum ada data tenaga medis yang tersedia</p>
            </div>
          </Card>
        </div>
      );
  ...
  return (
    <Panel header="Data Tenaga Medis" className="m-0">
      {header()}
        ...
        {selectedData && (
          <div className="flex flex-column gap-4">
            ...
            <div className="grid">
              ...
              <div className="col-12">
                <Panel header="Sertifikasi & Izin Praktik">
                  <div className="grid">
                    <div className="col-12 md:col-6">
