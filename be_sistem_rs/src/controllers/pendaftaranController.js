...
export async function createPendaftaran(req, res) {
  try {
    const { NIK, TANGGALKUNJUNGAN, LAYANAN, POLI, NAMADOKTER, STATUSKUNJUNGAN } = req.body;
    await PendaftaranModel.create({ NIK, TANGGALKUNJUNGAN, LAYANAN, POLI, NAMADOKTER, STATUSKUNJUNGAN });
...
export async function updatePendaftaran(req, res) {
  try {
    ...
    const result = await PendaftaranModel.update(id, { NIK, TANGGALKUNJUNGAN, LAYANAN, POLI, NAMADOKTER, STATUSKUNJUNGAN });
