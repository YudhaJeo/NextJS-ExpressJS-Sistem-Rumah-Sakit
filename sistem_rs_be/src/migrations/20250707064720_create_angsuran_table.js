...
export const up = function (knex) {
  return knex.schema.createTable('angsuran', (table) => {
    ...
    table.double('JUMLAHTOTAL', 15, 2).notNullable();
    table.double('JUMLAH_TERBAYAR', 15, 2).defaultTo(0);
    table.double('SISA_ANGSURAN', 15, 2).notNullable();
    table.double('JUMLAH_CICILAN', 15, 2).notNullable();
