...
export const getAll = async () => {
  const rows = await db('reservasi_rajal')
    .join('pasien', 'reservasi_rajal.NIK', 'pasien.NIK')
    .join('poli', 'reservasi_rajal.IDPOLI', 'poli.IDPOLI')
...
export const create = (data) => {
  return db('reservasi_rajal').insert(data);
}

export const update = (id, data) => {
  return db('reservasi_rajal').where('IDRESERVASI', id).update(data);
}

export const remove = (id) => {
  return db('reservasi_rajal').where('IDRESERVASI', id).del();
}
